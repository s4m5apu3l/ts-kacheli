  ...
  <main>
    ...
    <section class="pb-[200px] pt-[76px] border border-[#2D2D2D]">
      <div class="l-wrapper flex justify-between items-center ">
        <div class="max-[850px]:flex-col flex justify-between w-full items-center gap-[20px]">
          ...
          <div class="flex items-center">
            ...
            <a href="/aksii" class="py-[6px] px-[21px] text-base font-bold leading-[18px] text-white active-news-link">Акции</a>
            <a href="/skidki" class="py-[6px] px-[21px] text-base font-bold leading-[18px] text-white ">Скидки</a>
          </div>
      ...
      <div class=" l-wrapper max-[768px]:mt-[40px] mt-[80px] max-[560px]:px-[22px] max-[1250px]:px-[50px] max-[1400px]:px-[100px] px-[178px] overflow-x-hidden">
        <div id="aksii-container" class="grid-items-news gap-[1px] max-[850px]:mt-[60px] mt-[80px] max-[950px]:grid-cols-2  grid-cols-3 grid">
